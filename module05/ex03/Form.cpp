...
void Form::beSigned(const Bureaucrat &b)
{
	if (b.getGrade() > this->_sign_grade)
		throw Form::GradeTooLowException();
	if (this->_signed)
		throw Form::AllReadySignedException();
	this->_signed = true;
}

void Form::throwTooLow() const
{
	throw Form::GradeTooLowException();
}

void Form::throwTooHigh() const
{
	throw Form::GradeTooHighException();
}

void Form::throwNotReadySigned() const
{
	throw Form::NotReadySignedException();
}
...
const char *Form::NotReadySignedException::what() const throw()
{
	return "form not signed.";
}

const char *Form::AllReadySignedException::what() const throw()
{
